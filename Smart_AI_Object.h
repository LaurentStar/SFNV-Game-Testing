#ifndef SMART_AI_OBJECT_H_INCLUDED
#define SMART_AI_OBJECT_H_INCLUDED
#include "Physics.h"
#include "External_Configuration.h"
#include "Soul.h"


class Smart_AI_Object: public Soul 
 { 
	private: 	
	...
	public: 
		...
		Smart_AI_Object(int x, int y,  int z, int object_type, int object_location); 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		void Variable_Setter_Ai_Brain_Conditional(int,Ai_Brain){}
